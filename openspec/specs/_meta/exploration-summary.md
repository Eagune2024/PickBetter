...
## 探索时间
- 初始探索: 2025-02-26
- 规范同步: 2026-03-05 (ai-dialog-prompt 变更)
...
#### 4. 元素选择器 Capability (element-picker)
📄 `openspec/specs/element-picker/spec.md`

**内容概述** (2026-03-05 同步):
- 三状态机管理 (IDLE/PICKING/SELECTED)
- 状态转换逻辑和事件处理
- 鼠标事件过滤机制
- 键盘快捷键响应
- 覆盖层动态管理
...
#### 5. AI 对话框 Capability (picker-ai-dialog)
📄 `openspec/specs/picker-ai-dialog/spec.md`

**内容概述** (2026-03-05 新增):
- 对话框显示和自动聚焦
- 智能定位算法 (优先外部，无空间时放内部)
- 对话框交互 (Enter 提交/ESC 取消)
- 深色主题样式规范
- 事件隔离机制
- 状态管理集成
